...
vector < vector <float> > blur(vector < vector < float> > grid, float blurring) {
	...
	vector<float> subWindow1;
	subWindow1.push_back(corner_prob);
	subWindow1.push_back(adjacent_prob);
	subWindow1.push_back(corner_prob);

	window.push_back(subWindow1);

	vector<float> subWindow2;
	subWindow2.push_back(adjacent_prob);
	subWindow2.push_back(center_prob);
	subWindow2.push_back(adjacent_prob);

	window.push_back(subWindow2);

	vector<float> subWindow3;
	subWindow3.push_back(corner_prob);
	subWindow3.push_back(adjacent_prob);
	subWindow3.push_back(corner_prob);

	window.push_back(subWindow3);
